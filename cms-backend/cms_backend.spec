...
_extra_hidden = [
    ...
    'backend.dashboard',
    # app configs — required by INSTALLED_APPS AppConfig entries
    'about.apps',
    'blog.apps',
    'branding.apps',
    'careers.apps',
    ...
    'stakeholders.apps',
    'theme.apps',
    # app models, views, urls, admin — ensure full bundling
    'about.models', 'about.views', 'about.admin', 'about.urls',
    'blog.models', 'blog.views', 'blog.admin', 'blog.urls',
    'branding.models', 'branding.views', 'branding.admin',
    'careers.models', 'careers.views', 'careers.admin',
    'cms.models', 'cms.views', 'cms.admin',
    'contact.models', 'contact.views', 'contact.admin',
    'core.models', 'core.views', 'core.admin',
    'homepage.models', 'homepage.views', 'homepage.admin',
    'leads.models', 'leads.views', 'leads.admin',
    'legal.models', 'legal.views', 'legal.admin',
